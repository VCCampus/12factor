      ...
      <div className="relative h-96 mb-6">
        {isWebView ? (
          ...
          <div className="relative h-full" onClick={onFlip}>
            ...
            >
              <div className={`h-full bg-gradient-to-br ${stageColors[principle.stage as keyof typeof stageColors]} rounded-xl shadow-lg p-8 text-stone-800 flex flex-col justify-center border border-[#95a76f]/20`}>
            ...
            >
              <div className="h-full bg-gradient-to-br from-stone-50 to-[#95a76f]/10 dark:from-stone-800 dark:to-[#95a76f]/20 rounded-xl shadow-lg p-8 flex flex-col justify-center border border-[#95a76f]/30 dark:border-[#95a76f]/40">
